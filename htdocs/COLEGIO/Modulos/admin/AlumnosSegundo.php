	...
	<nav>
	 ...
	 <article id="article">
		...
		<?php
			...
			echo "<br><br><b>Lista de Estudiantes de 2do año</b><br><br>";
			$sql = "SELECT nacionalidad_alum,ci_alum, primer_nom_alum, seg_nom_alum, primer_ape_alum, seg_ape_alum, telefono_alum, email_alum FROM alumno WHERE estatus=1 AND año_idaño=2";
		...
		?>
			...
			<br><button type="button" onclick="window.open('../../PDF/ListaSegundo.php')" formtarget="_blank">IMPRIMIR</button>
			<br>
		<?php
   			}
