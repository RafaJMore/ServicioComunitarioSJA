...
<body>
	...
	<?php 
		...
		$fila = mysqli_fetch_assoc($result);
			...
			if ($fila["estatus"] == 0) {
				echo "<br><br><br><br><br>"."<b> *** EL ESTUDIANTE YA SE ENCUENTRA BLOQUEADO *** </b>"."<br><br><br><br><br><br>";
			} else {
				
				$sql = "UPDATE alumno SET estatus = b'0' WHERE ci_alum='$ci_alum'";

				if ($conn->query($sql) === TRUE) {
    		echo "<br><br><br><br><br>"."<b>ESTUDIANTE BLOQUEADO!!!</b>"."<br><br><br><br><br><br>";
				} else {
