...
<body>
	...
	<article id="article">
		...
		<?php
			...
			$sql = "SELECT nacionalidad_alum, ci_alum, primer_nom_alum, seg_nom_alum, primer_ape_alum, seg_ape_alum, telefono_alum, email_alum, año_idaño FROM alumno WHERE estatus = 1 AND ci_alum = '$ci_alum'";
